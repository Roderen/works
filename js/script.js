...
//   if (arr.constructor !== String) throw new Error('This element is not an array')
//   if (from >= arr.length - 1) return -1
...
// console.log(lastIndexOfMethod(stroke, 'World'))
// console.log(stroke.lastIndexOf('World', 6))